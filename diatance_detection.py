# The green colour object is detected and distance from the camera is printed live in the output.
...
def get_dist(rectange_params,image):
    ...
    #Wrtie n the image
    image = cv2.putText(image, 'Distance from Camera in mm :', org, font,  
